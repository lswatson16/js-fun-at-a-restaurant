...
var vegetables = ["pepper", "potato", "lettuce", "brocolli", "carrots"];
...
// different fruits.
var fruits = ["apple", "banana", "cherry", "blueberry", "raspberry", "strawberry", "mango"];
...
var groceryStore = {
  ...
  isOpen: true,
  staffCount: 21,
  managementTeamNames:["Bob", "Billy", "Brenda"]
}
